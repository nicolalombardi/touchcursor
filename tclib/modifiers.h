...
#ifndef MODIFIERS_INCLUDED
#define MODIFIERS_INCLUDED

const int shiftFlag = 0x00010000;
const int ctrlFlag  = 0x00020000;
const int altFlag   = 0x00040000;
const int winFlag   = 0x00080000;

#endif //ndef MODIFIERS_INCLUDED